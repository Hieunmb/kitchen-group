...
@NgModule({
  declarations: [
    ...
    AboutusComponent, ShopComponent, PageComponent, ContactComponent , RegisterComponent ,SigninComponent, ProductComponent,
    CartComponent, MywishlistComponent, DeliveryComponent
  ],
  imports: [
